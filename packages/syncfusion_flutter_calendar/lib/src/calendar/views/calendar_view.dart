...
class _CalendarViewState extends State<_CalendarView>
  ...
  final UpdateCalendarStateDetails _updateCalendarStateDetails =
      UpdateCalendarStateDetails();
  ValueNotifier<calendarHelper.SelectionDetails?> _allDaySelectionNotifier =
  ValueNotifier<calendarHelper.SelectionDetails?>(null);
  ...
  void didUpdateWidget(_CalendarView oldWidget) {
    ...
    if (oldWidget.view != widget.view) {
      _allDaySelectionNotifier = ValueNotifier<calendarHelper.SelectionDetails?>(null);
      final DateTime today = DateTime.now();
      _currentTimeNotifier = ValueNotifier<int>(
          (today.day * 24 * 60) + (today.hour * 60) + today.minute);
      _timer?.cancel();
  ...
  void _updateAllDaySelection(AppointmentView? view, DateTime? date) {
    ...
    _allDaySelectionNotifier.value = calendarHelper.SelectionDetails(view, date);
  }
